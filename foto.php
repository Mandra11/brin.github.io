...
<php lang="en" class="no-js">
  ...
  <body class="single">
            ...
            <li class="nav-item active">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdownMenuButton2" data-toggle="dropdown"
                  aria-haspopup="true" aria-expanded="false">Galeri <span class="sr-only">(current)</span></a>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdownMenuButton2" data-toggle="dropdown"
                  aria-haspopup="true" aria-expanded="false">Lainya <span class="sr-only">(current)</span></a>
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink_1">
    ...
    <div class="responsive">
      <div class="gallery">
        <a target="_blank" href="images/potoarsip.jpeg">
          <img src="images/potoarsip.jpeg" alt="Cinque Terre" style="width: 360px;height:245px;">
        </a>
    ...
    <div class="responsive">
      <div class="gallery">
        <a target="_blank" href="images/fotoarsip2.jpeg">
          <img src="images/fotoarsip2.jpeg" alt="Forest" style="width: 360px;height:245px;">
        </a>
        <div class="desc">Add a description of the image here</div>
      </div>
    </div>
    ...
    <div class="responsive">
      <div class="gallery">
        <a target="_blank" href="images/fotoarsip1.jpeg">
          <img src="images/fotoarsip1.jpeg" alt="Northern Lights" style="width: 360px;height:245px;">
        </a>
        <div class="desc">Add a description of the image here</div>
      </div>
    </div>
    ...
    <div class="responsive">
      <div class="gallery">
        <a target="_blank" href=images/fototerbaru.jpeg">
          <img src="images/fototerbaru.jpeg" alt="Mountains" style="width: 360px;height:245px;">
        </a>
        <div class="desc">Add a description of the image here</div>
      </div>
    </div>
    ...
    <div class="responsive">
      <div class="gallery">
        <a target="_blank" href="images/pemusnahanarsip.jpeg">
          <img src="images/pemusnahanarsip.jpeg" alt="Cinque Terre" style="width: 360px;height:245px;">
        </a>
        <div class="desc">Add a description of the image here</div>
      </div>
    </div>
    ...
    <div class="responsive">
      <div class="gallery">
        <a target="_blank" href="images/pemusnahan arsip foto ke 2.jpg">
          <img src="images/pemusnahan arsip foto ke 2.jpg" alt="Forest" style="width: 360px;height:245px;">
        </a>
        <div class="desc">Add a description of the image here</div>
      </div>
    </div>
    ...
    <div class="responsive">
      <div class="gallery">
        <a target="_blank" href="images/Picture16.png">
          <img src="images/Picture16.png" alt="Cinque Terre" style="width: 360px;height:245px;">
        </a>
        <div class="desc">Add a description of the image here</div>
      </div>
    </div>
    ...
    <div class="responsive">
      <div class="gallery">
        <a target="_blank" href="images/Tusi.png">
          <img src="images/Tusi.png" alt="Forest" style="width: 360px;height:245px;">
        </a>
        <div class="desc">Add a description of the image here</div>
      </div>
    </div>
    ...
    <div class="container animate-box">
        <div class="row">
            <div class="col-12 spdp_right py-5"><img src="images/Logo BRIN_Lanscape_Colour.png"" alt="img" class="footer_logo"/></div>
            <div class="clearfix"></div>
            <div class="col-12 col-md-4 col-lg-3">
                <div class="footer_main_title py-3"> Sekilas Layanan Arsip </div>
                <div class="footer_sub_about pb-3"style="text-align: justify;"> Arsip sering dibutuhkan dan dipakai dalam bidang manajemen serta administrasi".
            ...
            <div class="col-12 col-md-12 col-lg-4 ">
                ...
                <a href="#" class="footer_img_post_6"><img src="images/pemusnahan arsip foto ke 2.jpg" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="images/STRUKTUR ORGANISASI_page-0001.jpg" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="images/kunjunganarsipkarangsambung.jpg" alt="img"/></a>
