            ...
            <div class="row mx-0">
                <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="col-md-7 animate-box">
                            <a href="berita1.php" class="fh5co_magna py-2"> Pemusnahan Arsip Tahap 1 </a> <a href="#"
                                class="fh5co_mini_time py-3"> Layanan Sistem Informasi Kearsipan Yogyakarta -
                                April 18,2016 </a>
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="col-md-7">
                            <a href="berita2.php" class="fh5co_magna py-2">Layanan Arsip Kawasan Yogyakarta Studi
                                Banding Kearsipan UGM. </a> <a href="#" class="fh5co_mini_time py-3">
                                Layanan Sistem Informasi Kearsipan Yogyakarta - April 18,2016 </a>
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="col-md-7">
                            <a href="berita3.php" class="fh5co_magna py-2"> Kunjungan Tim Layanan Arsip Karang Sambung
                                Kebumen.
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="col-md-7">
                            <a href="single.php" class="fh5co_magna py-2"> Pemusnahan Arsip Tahap 1 . </a> <a href="#"
                                class="fh5co_mini_time py-3">Layanan Sistem Informasi Kearsipan Yogyakarta -
                                April 18,2016 </a>
                            <div class="fh5co_consectetur">Pada
                                hari Senin, tanggal 11 Maret 2023, Tim Layanan Arsip Kawasan Yogyakarta Badan Riset dan
                ...
                <div class="row pb-3">
                    ...
                    <div class="col-7 paddding">
                        <div class="most_fh5co_treding_font"> Layanan Arsip Kawasan Yogyakarta Studi Banding Kearsipan UGM .</div>
                ...
                <div class="row pb-3">
                    ...
                    <div class="col-7 paddding">
                        <div class="most_fh5co_treding_font">  Kunjungan Tim Layanan Arsip Karang Sambung Kebumen.</div>
                        <div class="most_fh5co_treding_font_123"> April 18, 2016</div>
                    </div>
                </div>
                <div class="row pb-3">
            ...
            <div class="owl-carousel owl-theme" id="slider2">
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_news_img"><img src="images/kunjunganugm.png" alt="" /></div>
                        <div>
                            <a href="#" class="d-block fh5co_small_post_heading"><span class="">Layanan Arsip Kawasan Yogyakarta Studi Banding Kearsipan UGM </span></a>
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_news_img"><img src="images/pemusnahanarsip.jpeg" alt="" /></div>
                        <div>
                            <a href="#" class="d-block fh5co_small_post_heading"><span class="">Pemusnahan Arsip Tahap 1</span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        </div>
                    </div>
                </div>
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_news_img"><img src="images/pemusnahan arsip foto ke 2.jpg" alt="" /></div>
                        <div>
                            <a href="#" class="d-block fh5co_small_post_heading"><span class="">Pemusnahan Arsip Tahap 1</span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        </div>
        ...
        <div class="container">
            <div class="row  ">
                <div class="col-12 col-md-6 py-4 Reserved"> © Copyright 2018, All rights reserved. Design by <a
                        href="https://freehtml5.co" title="Free html5 Bootstrap templates">Freephp5.co</a>. </div>
