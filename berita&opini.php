...
<php lang="en" class="no-js">
    ...
    <body class="single">
        ...
        <div id="fh5co-title-box"
            style="background-image: url(images/pemusnahanarsip.jpeg); background-position: 50% 90.5px;"
            data-stellar-background-ratio="0.5">
            <div class="overlay"></div>
            <div class="page-title">
                <img src="" alt="">
                <span>January 1, 2018</span>
                <h2>Pemusnahan Arsip Tahap 1</h2>
            </div>
        </div>
                ...
                <div class="row mx-0">
                    <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                        <p>
                            ...
                            Inovasi Nasional
                            menyaksikan proses pemusnahan arsip tahap 1 yang dilaksanakan oleh pihak ke tiga, UD Sregep.
                            Proses
                            pemusnahan ini dilakukan di wilayah Tlogo Adi, Mlati, Sleman,
                            Yogyakarta. Pemusnahan arsip dalam tahap 1 ini berasal dari tiga eks entitas, yaitu Balai
                            Penelitian
                            Teknologi Bahan Alam (BPTBA-LIPI), eks Balai Teknologi Infrastruktur Pelabuhan dan Dinamika
                            Pantai
                            (BTIPDP–BPPT), serta eks Sekolah Tinggi Teknologi Nuklir (STTN-BATAN). Pelaksanaan
                            pemusnahan arsip
                            dilaksanakan secara serentak di lingkungan Badan Riset dan Inovasi Nasional berdasarkan pada
                            Nota Dinas
                            Kepala Biro Komunikasi Publik, Umum dan Kesekretariatan (BKPUK) Nomor
                            T-156/II.2.5/KA.04.01/3/2023.
                            Pelaksanaan Pemusnahan Arsip Badan Riset dan Inovasi Nasional serta berdasarkan Jadwal
                            Retensi Arsip,
                            dan Penilaian Arsip, telah melaksanakan pemusnahan arsip eks LIPI, LAPAN, BATAN, BPPT,
                            RISTEK sebanyak
                            97.089 nomor sebagaimana tercantum dalam Daftar Arsip yang dimusnahkan.
                            Proses pemusnahan arsip dilakukan sesuai dengan aturan dan perundangan yang berlaku, untuk
                            menjamin
                            setiap informasi yang terdapat pada arsip telah musnah bersama fisik arsip. Hal ini telah
                            diatur dalam
                            Peraturan Kepala Arsip Nasional Republik Indonesia Nomor 25 Tahun 2012 Tentang Pedoman
                            Pemusnahan Arsip.
                            Pemusnahan dapat dilakukan dengan cara, antara lain: 1) Pembakaran, 2) Pencacahan, 3)
                            Penggunaan bahan
                            kimia, 4) Pulping dan 5) Cara-cara lain yang memenuhi kriteria yang disebut dengan istilah
                            musnah.
                        </p>
                        <p>
                    ...
                    <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                        <div>
                            ...
                            <div class="row pb-3">
                                ...
                                <div class="col-7 paddding">
                                    <div class="most_fh5co_treding_font"> Magna aliqua ut enim ad minim veniam quis
                                        nostrud.</div>
                            ...
                            <div class="row pb-3">
                                <div class="col-5 align-self-center">
                                    <img src="images/pemusnahanarsip (1).jpeg" alt="img" class="fh5co_most_trading" />
                                </div>
                                <div class="col-7 paddding">
                                    <div class="most_fh5co_treding_font"> Enim ad minim veniam nostrud xercitation
                                        ullamco.</div>
                                    <div class="most_fh5co_treding_font_123"> April 18, 2016</div>
                                </div>
                            </div>
                        ...
                        <div class="Youtube_YoutubeWrapper-sc-1m53ay4-0 bFDXAu video-responsive">
                            <div>
                                <h2 title="Video" class="Title_TitleWrapper-sc-1u1krc8-0 XucQQ"><i class="fas fa-video "
                                        style="padding-right: 10px;"></i>Video</h2>
                            </div><iframe width="120% " height="410px"
                                src="https://www.youtube.com/embed/b3FEKomMnN0?start=60" frameborder="0"
                                allowfullscreen="" title="BRIN Video"></iframe>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-3 col-lg-2">
                            ...
                            <ul class="footer_menu">
                                ...
                                <li><a href="#" class=""><i class="fa fa-angle-right"></i>&nbsp;&nbsp; Environment</a>
                                </li>
                                <li><a href="#" class=""><i class="fa fa-angle-right"></i>&nbsp;&nbsp; Health</a></li>
                                <li><a href="#" class=""><i class="fa fa-angle-right"></i>&nbsp;&nbsp; Life style</a>
                                </li>
                                <li><a href="#" class=""><i class="fa fa-angle-right"></i>&nbsp;&nbsp; Politics</a></li>
                                <li><a href="#" class=""><i class="fa fa-angle-right"></i>&nbsp;&nbsp; Technology</a>
                                </li>
                ...
                <div class="container">
                    <div class="row  ">
                        <div class="col-12 col-md-6 py-4 Reserved"> © Copyright 2018, All rights reserved. Design by <a
                                href="https://freehtml5.co" title="Free php5 Bootstrap templates">Freephp5.co</a>.
                        </div>
